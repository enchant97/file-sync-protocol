...
\begin{table}[h!]
	...
	\begin{tabular}{l l l l l}
		...
		\hline
		\textbf{SMB}        & 2,049,153            & 323                    & 49,153                  & 2.40\%               \\
		\hline
		...
		\hline
		\textbf{SMB}        & 172,501              & 528                    & 99,747                  & 57.82\%              \\
		\hline
		...
		\hline
		\textbf{SMB}        & 67,551,796           & 2,879                  & 310,103                 & 0.46\%               \\
		\hline
		...
		\hline
		\textbf{SMB}        & 2,945,640            & 11,194                 & 2,433,640               & 82.62\%              \\
		\hline
...
In conclusion these test results show that rsync seems to perform well at using the minimal amount of overhead. Despite FTP and SMB2 performing worse, it does not mean that they are unsuitable for transferring files across a network. They still performed well when transferring larger files as seem in the photos test results. However they would seem unsuitable for transferring many small files on a network with minimal amounts of bandwidth available.
