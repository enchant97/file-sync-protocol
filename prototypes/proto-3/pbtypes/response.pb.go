...
func (x *ErrDat) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ErrDat) ProtoMessage() {}

func (x *ErrDat) ProtoReflect() protoreflect.Message {
	mi := &file_response_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ErrDat.ProtoReflect.Descriptor instead.
func (*ErrDat) Descriptor() ([]byte, []int) {
	return file_response_proto_rawDescGZIP(), []int{2}
}

func (x *ErrDat) GetRequestId() uint64 {
	if x != nil {
		return x.RequestId
	}
	return 0
...
func (x *ErrDat) GetChunkIds() []uint64 {
	if x != nil {
		return x.ChunkIds
	}
	return nil
...
var file_response_proto_rawDesc = []byte{
	...
	,
...
var file_response_proto_goTypes = []interface{}{
	(*Syn)(nil),    // 0: response.Syn
	(*Ack)(nil),    // 1: response.Ack
	(*ErrDat)(nil), // 2: response.ErrDat
}
